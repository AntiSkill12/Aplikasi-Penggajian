...
<head>
    ...
    <link rel="stylesheet" href="../../asset/css/jobbeKar.css">
...
<body>
    ...
    <p class="list">List Data Jabatan</p>
        ...
        <div class="border">
        <div class="tambah">
            <p class="tambah2"><a href="http://localhost/Gaji_karyawan/aplikasi/view/jabatan/tambah_jabatan.php">TAMBAH DATA <i class="bi bi-plus-square-fill"></i></a></p>
        </div>
        ...
        <table id="jabatan-table" border="1" align="right">
            ...
            <tr>
                ...
                ?>
                    <tr>
                        <td align="center">
                            <a href="http://localhost/Gaji_karyawan/aplikasi/view/Jabatan/hapusdata.php?id=<?php echo $data['id']; ?>"><i class="bi bi-trash3-fill"></i></a>
                        </td>
                        <td align="center">
                            <a href="http://localhost/Gaji_karyawan/aplikasi/view/Jabatan/editdata.php?id=<?php echo $data['id']; ?>"><i class="bi bi-pencil-square"></i></a>
                        </td>
