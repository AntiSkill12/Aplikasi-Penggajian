...
<head>
    ...
    <link rel="stylesheet" href="../../asset/css/absenPoto.css">
...
<body>
  ...
  <div class="border">
    <div class="tambah">
      <p class="tambah2"><a href="http://localhost/Gaji_karyawan/aplikasi/view/Absensi/tambah_absen.php">TAMBAH DATA <i class="bi bi-plus-square-fill"></i></a></p>
